...
<body>
  ...
  <div id="wrapper" class="wrapper-container">
    ...
    <header id="header" class="header style-4 wide sticky-header">
                        ...
                        <li class="sub"><a href="#">Header Layouts</a>
                          ...
                          <div class="sub-menu-wrap sub-menu-inner">
                            <ul>
                              ...
                              <li><a href="header_2.html">Header 2</a></li>
                  ...
                  <li class="current"><a href="#">Pages</a>
                    ...
                    <div class="sub-menu-wrap">
                      <ul>
                        ...
                        <li class="current sub"><a href="#">Ministries</a>
                          <!--sub menu-->
                          <div class="sub-menu-wrap sub-menu-inner">
                            <ul>
                              <li><a href="ministries_v1.html">Our Ministries v1</a></li>
                              <li><a href="ministries_v2.html">Our Ministries v2</a></li>
                              <li class="current"><a href="ministries_single.html">Single Ministry Page</a></li>
                            </ul>
                          </div>
                        </li>
    ...
    <div class="breadcrumbs-wrap no-title">
      ...
      <div class="container">
        ...
        <ul class="breadcrumbs">
          ...
          <li><a href="ministries_v1.html">Our Ministries</a></li>
          <li>Kids Ministry</li>
        ...
        <div class="row">
          ...
          <main id="main" class="col-lg-9">
            ...
            <figure class="content-element3">
              <img src="images/1005x588_img6.jpg" alt="">
            </figure>

            <div class="content-element3">
              
              <p>Aliquam congue fermentum nisl. Mauris accumsan nulla vel diam. Sed in lacus ut enim adipiscing aliquet. Nulla venenatis. In pede mi, aliquet sit amet, euismod in, auctor ut, ligula. Aliquam dapibus tincidunt metus. Praesent justo dolor, lobortis quis, lobortis dignissim, pulvinar ac, lorem. Aliquam erat volutpat. Duis ac turpis. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Mauris fermentum dictum magna. </p>
              ...
              <div class="portfolio-holder flex-row item-col-4">
                ...
                <div class="project">
                  ...
                  <div class="project-image">
                    ...
                    <img src="images/236x196_img1.jpg" alt="">
                        
                    <a href="images/236x196_img1.jpg" class="project-link" data-fancybox="gallery2"></a>
                ...
                <div class="project">
                  ...
                  <div class="project-image">
                    ...
                    <img src="images/236x196_img2.jpg" alt="">
                        
                    <a href="images/236x196_img2.jpg" class="project-link" data-fancybox="gallery2"></a>
                ...
                <div class="project">
                  ...
                  <div class="project-image">
                    ...
                    <img src="images/236x196_img3.jpg" alt="">
                        
                    <a href="images/236x196_img3.jpg" class="project-link" data-fancybox="gallery2"></a>
                ...
                <div class="project">
                  ...
                  <div class="project-image">
                    ...
                    <img src="images/236x196_img4.jpg" alt="">
                        
                    <a href="images/236x196_img4.jpg" class="project-link" data-fancybox="gallery2"></a>
            ...
            <p>Ut pharetra augue nec augue. Nam elit agna,endrerit sit amet, tincidunt ac, viverra sed, nulla. Donec porta diam eu massa. Quisque diam lorem, interdum vitae,dapibus ac, scelerisque vitae, pede. Donec eget tellus non erat lacinia fermentum. Donec in velit vel ipsum auctor pulvinar. Vestibulum iaculis lacinia est. Proin dictum elementum velit. </p>
          ...
          <aside id="sidebar" class="col-lg-3">
              ...
              <div class="entry-box entry-small">
                ...
                <div class="entry-col">
                  ...
                  <div class="entry">
                    ...
                    <div class="thumbnail-attachment">
                      <a href="#"><img src="images/84x84_photo4.jpg" alt=""></a>
                    </div>
                    
                    <!-- - - - - - - - - - - - - - Entry body - - - - - - - - - - - - - - - - -->
                    <div class="entry-body">
                          
                      <h6 class="entry-title"><a href="#">Robert Smith</a></h6>
                      <div class="entry-meta">
                        
                        <span>Kid’s Pastor</span>
                ...
                <div class="entry-col">
                  ...
                  <div class="entry">
                    ...
                    <!-- - - - - - - - - - - - - - Entry attachment - - - - - - - - - - - - - - - - -->
                    <div class="thumbnail-attachment">
                      <a href="#"><img src="images/84x84_photo5.jpg" alt=""></a>
                    </div>
                    
                    <!-- - - - - - - - - - - - - - Entry body - - - - - - - - - - - - - - - - -->
                    <div class="entry-body">
                          
                      <h6 class="entry-title"><a href="#">John Anderson</a></h6>
                      <div class="entry-meta">
                        
                        <span>Kid’s Director</span>
            ...
            <div class="widget">
              ...
              <div class="event-box style-2">
                ...
                <div class="event">
                  ...
                  <div class="event-body">
                    ...
                    <h6 class="event-title"><a href="#">Mission Vision School</a></h6>

                    <p class="e-info">12:00 AM - 5:00 PM 8901 Marmora Road, Glasgow, D04 89GR</p>
                ...
                <div class="event">
                  ...
                  <div class="event-body">
                    ...
                    <h6 class="event-title"><a href="#">Mother’s Day</a></h6>
                ...
                <div class="event">
                  ...
                  <div class="event-body">
                    ...
                    <h6 class="event-title"><a href="#">Easter Sunday</a></h6>
              ...
              <a href="#" class="btn btn-small btn-style-6">More Events</a>
