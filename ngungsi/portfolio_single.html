...
<body>
  ...
  <div id="wrapper" class="wrapper-container">
    ...
    <header id="header" class="header style-4 sticky-header wide">
            ...
            <div class="nav-item">
              ...
              <nav id="main-navigation" class="main-navigation">
                <ul id="menu" class="clearfix">
                  ...
                  <li class="current"><a href="#">Gallery</a>
                    <!--sub menu-->
                    <div class="sub-menu-wrap">
                      <ul>
                        ...
                        <li class="current"><a href="portfolio_single.html">Single Portfolio Post</a></li>
                      </ul>
                    </div>
                  </li>
                  <li><a href="#">Blog</a>
    ...
    <div id="content" class="page-content-wrap">
      ...
      <div class="container wide">
        ...
        <div class="content-element">
            ...
            <div class="content-element3">
              <div class="carousel-type-2 var3">
                ...
                <div class="owl-carousel" data-max-items="1">
                  ...
                  <img src="images/1350x728_img1.jpg" alt="">
                  <img src="images/1350x728_img2.jpg" alt="">
                  <img src="images/1350x728_img3.jpg" alt="">
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                  ...
                  <ul class="custom-list">
                    ...
                    <li><span>Category:</span> <a href="#" class="link-text">Church</a></li>
                    <li><span>Author:</span> <a href="#" class="link-text">Adam Smith</a></li>
          ...
          <div class="page-nav">
            <div class="flex-item"><a href="#" class="btn btn-small btn-style-6 prev-btn">Previous Project</a></div>
            <a href="#" class="menu-button"><i class="licon-icons"></i></a>
            <div class="flex-item"><a href="#" class="btn btn-small btn-style-6 next-btn">Next Project</a></div>
          </div>
          ...
          <div class="item-col">
            ...
            <div class="project">
              ...
              <div class="project-image">
                ...
                <img src="images/430x308_img10.jpg" alt="">
                    
                <a href="images/430x308_img10.jpg" class="project-link" data-fancybox="gallery"></a>
                    
              </div>

              <div class="project-description">
                
                <h4 class="project-title"><a href="#">Child Education</a></h4>

                <a href="#" class="project-cats">Missions</a>
          ...
          <div class="item-col">
            ...
            <div class="project">
              ...
              <div class="project-image">
                ...
                <img src="images/430x308_img11.jpg" alt="">
                    
                <a href="images/430x308_img11.jpg" class="project-link" data-fancybox="gallery"></a>
                    
              </div>

              <div class="project-description">
                
                <h4 class="project-title"><a href="#">Celebrate Recovery </a></h4>

                <a href="#" class="project-cats">Events</a>
          ...
          <div class="item-col">
            ...
            <div class="project">
              ...
              <div class="project-image">
                ...
                <img src="images/430x308_img7.jpg" alt="">
                    
                <a href="images/430x308_img7.jpg" class="project-link" data-fancybox="gallery"></a>
                    
              </div>

              <div class="project-description">
                
                <h4 class="project-title"><a href="#">Our Work With Refugees</a></h4>
