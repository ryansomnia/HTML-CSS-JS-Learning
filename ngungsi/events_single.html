    ...
    <header id="header" class="header style-3 sticky-header">
      ...
      <div class="top-header container wide">
        ...
        <div class="logo-wrap">
          ...
          <a href="index.html" class="logo"><img src="images/logo4.png" alt=""></a>
          ...
          <div class="nav-item">
            ...
            <nav id="main-navigation" class="main-navigation">
              <ul id="menu" class="clearfix">
                ...
                <li class="current"><a href="#">Events</a>
                  <!--sub menu-->
                  <div class="sub-menu-wrap">
                    <ul>
                      ...
                      <li class="current"><a href="events_single.html">Single Event Page</a></li>
                    </ul>
                  </div>
                </li>
      ...
      <div class="container wide">
        ...
        <div class="content-element2">
          ...
          <div class="flex-row justify-content-between align-items-center">
            ...
            <a href="#" class="btn btn-small btn-style-6 prev-btn type2">All Events</a>

            <div class="btn-wrap">
              <a href="#" class="btn btn-small btn-style-6 exp">Google Calendar</a>
              <a href="#" class="btn btn-small btn-style-6 exp">iCal Export</a>
            </div>
          ...
          <div class="event-box single-post">
            ...
            <div class="event">
              ...
              <div class="event-body">
                ...
                <h1 class="event-title">Easter Sunday</h1>

                <div class="entry-meta clearfix">
                    
                  March 18, 2019 @ 12:00 AM - 5:00 PM  |  Recurring Event (<a href="#">See All</a>)

                  <span class="price f-right">Free</span>
              ...
              <div class="content-element3">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="content-element3">
                      <img src="images/890x560_img1.jpg" alt="">
                    </div>
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6">
                          ...
                          <ul class="custom-list">
                            ...
                            <li><span>Date:</span> Apr 15 - May 13, 2018</li>
                            <li><span>Time:</span> 3:30 PM - 5:00 PM</li>
                            <li><span>Cost:</span> <span class="product-price">Free</span></li>
                            <li><span>Event Category:</span> <a href="#" class="link-text">Training</a></li>
                            <li><span>Website:</span> <a href="#" class="link-text">http://www.companyname.com</a></li>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div id="googleMap" class="map-container content-element3"></div>

                    <h5 class="e-title">Venue</h5>
              ...
              <div class="page-nav">
                <div class="flex-item"><a href="#" class="btn btn-small btn-style-6 prev-btn">Previous Event</a></div>
                <div class="flex-item"><a href="#" class="btn btn-small btn-style-6 next-btn">Next Event</a></div>
              </div>
        ...
        <!-- Isotope -->
        <div class="isotope three-collumn clearfix event-box no-border style-2 grid-type" data-isotope-options='{"itemSelector" : ".item","layoutMode" : "masonry","transitionDuration":"0.7s","masonry" : {"columnWidth":".item"}}'>
          ...
          <div class="item">
            ...
            <div class="event">
              ...
              <div class="event-img">
                ...
                <a href="#"><img src="images/430x252_img5.jpg" alt=""></a>

              </div>
              
              <div class="event-body">
                
                <h5 class="event-title"><a href="#">Mission Vision School</a></h5>

                <p class="e-info">March 18, 2018 @ 12:00 AM - 5:00 PM <br>
                8901 Marmora Road, Glasgow, D04 89GR</p>

                <p>Aliquam erat volutpat. Duis ac turpis. Donec sit amet eros. Lorem ipsum dolor. Mauris fermentum dictum magna. Sed laoreet aliquam leo. Ut tellus dolor, elementum vel, cursus eleifend, elit. Aenean auctor wisi et urna. </p>
          ...
          <div class="item">
            ...
            <div class="event">
              ...
              <div class="event-img">
                ...
                <a href="#"><img src="images/430x252_img6.jpg" alt=""></a>

              </div>
              
              <div class="event-body">
                
                <h5 class="event-title"><a href="#">Mother’s Day </a></h5>

                <p class="e-info">March 21, 2018 @ 12:00 AM - 5:00 PM <br>
                8901 Marmora Road, Glasgow, D04 89GR</p>
          ...
          <div class="item">
            ...
            <div class="event">
              ...
              <div class="event-img">
                ...
                <a href="#"><img src="images/430x252_img7.jpg" alt=""></a>

              </div>
              
              <div class="event-body">
                
                <h5 class="event-title"><a href="#">Easter Sunday</a></h5>

                <p class="e-info">March 24, 2018 @ 12:00 AM - 5:00 PM <br>
                8901 Marmora Road, Glasgow, D04 89GR</p>
