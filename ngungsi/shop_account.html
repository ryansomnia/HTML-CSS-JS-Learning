                  ...
                  <li class="current"><a href="#">Shop</a>
                    ...
                    <div class="sub-menu-wrap">
                      <ul>
                        ...
                        <li class="current"><a href="shop_account.html">My Account</a></li>
                      </ul>
                    </div>
                  </li>
                </ul>
          ...
          <main id="main" class="col-lg-9">
              ...
              <div class="table-type-1 recent-order responsive-table">
                <table>
                  ...
                  <tr>
                    ...
                    <td data-title="Date">December 17, 2019</td>
                    <td data-title="Status">Pending</td>
                    <td data-title="Total" class="total-price">$5.99</td>
                    <td><a href="#" class="btn btn-small">View</a></td>
                  </tr>
                  <tr class="bg-cell2">
                    <td data-title="Order #">12346</td>
                    <td data-title="Date">December 20, 2019</td>
                    <td data-title="Status">Pending</td>
                    <td data-title="Total" class="total-price">$31.30</td>
                    <td><a href="#" class="btn btn-small">View</a></td>
                  </tr>
                  <tr>
                    <td data-title="Order #">12347</td>
                    <td data-title="Date">December 15, 2019</td>
                    <td data-title="Status">Pending</td>
                    <td data-title="Total" class="total-price">$96.27</td>
                    <td><a href="#" class="btn btn-small">View</a></td>
                  </tr>
                </table>
              </div>
            ...
            <div class="content-element">
              ...
              <div class="content-element3">
                ...
                <p class="fw-medium tt-up">Hello, John Doe (not John Doe? <a href="#" class="link-text">Sign out</a>)</p>
              ...
              <div class="content-element3">
                ...
                <p class="fw-medium tt-up content-element1">My Addresses</p>
              ...
              <div class="content-element3">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <p class="fw-medium tt-up content-element1">Billing Address</p>
                    <ul class="text-size-medium content-element2">
                      <li>John Doe</li>
                      <li>Green street</li>
                  ...
                  <div class="col-sm-6">
                    ...
                    <p class="fw-medium tt-up content-element1">Shipping Address</p>
                    <ul class="text-size-medium content-element2">
                      <li>John Doe</li>
                      <li>Green street</li>
                      <li>12345 New York</li>
