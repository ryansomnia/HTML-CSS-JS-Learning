                  ...
                  <li class="current"><a href="#">Shop</a>
                    ...
                    <div class="sub-menu-wrap">
                      <ul>
                        ...
                        <li class="current"><a href="shop_checkout.html">Checkout</a></li>
    ...
    <div id="content" class="page-content-wrap">
      ...
      <div class="container wide">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="content-element1">
                       ...
                       <a href="#" class="btn btn-style-5">Login</a>
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="join-us style-3">
                    <form class="newsletter style-2 var2">
                      <input type="email" name="newsletter-email" placeholder="Enter coupon code">
                      <button type="submit" data-type="submit" class="btn btn-style-5">Apply Coupon</button>
                    </form>
                  </div>
        ...
        <div class="content-element7">
          ...
          <div class="row">
            <div class="col-md-6 col-sm-12">
              ...
              <h5 class="title"><b>Billing Details</b></h5>
              <form class="contact-form style-2">
            ...
            <div class="col-md-6 col-sm-12">
              ...
              <form class="contact-form style-2">
                ...
                <div class="contact-item">
                  ...
                  <textarea rows="12" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
        ...
        <div class="content-element3">
          ...
          <h5 class="title"><b>Your Order</b></h5>
          <div class="content-element4">
            ...
            <div class="shop-cart-form order-type table-type-1">
              <table>
                ...
                <tr>
                  ...
                  <td class="price total-price">$15.00</td>
                </tr>
                <tr>
                  <td data-title="Product">
                  ...
                  <td class="price total-price">$1.95</td>
                </tr>
                <tr>
                  <td class="order-total">
                    <div>Cart subtotal</div>
                  </td>
                  <td class="price total-price">$16.95</td>
                </tr>
                <tr>
                  <td class="order-total">
                    <div>Shipping</div>
          ...
          <a href="#" class="btn btn-style-5 btn-lg">Place Order</a>
